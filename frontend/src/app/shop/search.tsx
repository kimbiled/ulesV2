export default function Search () {
  return (
    <div className="rounded-[32px] bg-white flex items-center pl-5 gap-2 w-[722px] h-16">
      ...
      <input type="text" placeholder="Search here..." className="border-0 bg-white text-sm h-16 w-[650px]" />
    </div>
  )
}