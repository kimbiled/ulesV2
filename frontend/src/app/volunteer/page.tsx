...
export default function Volunteer() {
  ...
  const handleOnOrderOpen = (item: object) => {
  ...
  return (
    <Layout>
      <div className="w-full h-full flex flex-row justify-between mb-16 mt-16 fontRaleway">
        {/* <div className="  bg-gradient-linear2 rounded-3xl text-white flex flex-col ">
        ...
        <div className=" bg-gradient-linear3 rounded-3xl">
        ...
        <div className=" bg-gradient-linear2 rounded-3xl px-10">
          <h4 className="font-semibold text-[28px] text-white border-b-[1px] border-white p-4 px-10">
            Заказы
          </h4>
