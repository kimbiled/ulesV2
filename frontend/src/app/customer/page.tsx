				...
				<div className="w-[336px] h-auto bg-gradient-linear rounded-3xl text-white p-4">
					<div className="flex flex-col gap-5 justify-center w-[280px] justify-center m-auto">
						...
						<div className="w-auto h-11 rounded-xl border-[1px] border-white flex flex-col justify-center text-white p-4">
							...
							<input type="text" className="bg-transparent outline-none text-sm" placeholder="Кабайбай Батыра 51/1"/>
						</div>
						):
						(
						<div className="w-auto h-11 rounded-xl border-[1px] border-white flex flex-col justify-center text-white p-4">
						...
						{isChange? (
							<div className="flex w-full justify-center ">
								<button className="fontInter hover:bg-stone-200 w-52 h-8 bg-white text-black rounded-3xl mb-1 mt-1 text-sm" onClick={()=>setChange(false)}>Сохранить</button>
							</div>
						):
						(
						<div className="flex w-full justify-center ">
							<button className="fontInter hover:bg-stone-200 w-52 h-8 bg-white text-black rounded-3xl mb-1 mt-1 text-sm" onClick={()=>setChange(true)}>Изменить</button>
						</div>
						)}
					</div>
				</div>
