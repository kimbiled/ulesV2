    ...
    <nav className="fontInter w-full bg-[#4F82B0] px-16 flex py-2 justify-between items-center navbar">
      <div className="flex bg-gradientBlueBlack w-[100%] justify-between">
        <Link
          ...
          <p className=" font-poppins font-semibold text-[20px] cursor-pointer text-white">
            Úles
          </p>
        </Link>
      ...
      <div
        ...
        <Image
          src={profilePhoto}
          alt="Profile Photo"
          className="h-8 w-8 rounded-full dropDown-menu-active"
        />
        <p className="font-poppins text-white dropDown-menu-active cursor-pointer">
          {user && user.name}
        </p>
        ...
        <div
          ...
          <div className="w-full h-28 border-t-[1px] border-b-[1px] flex flex-col items-center justify-center gap-4">
            <Link href={'/profile'}>
              <button className="fontInter w-32 h-8 rounded-3xl bg-white text-sm">
                Профиль
              </button>
            </Link>
            <button
