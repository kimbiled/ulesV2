...
export default function Menu({ setPage }: { setPage: Dispatch<SetStateAction<number>> }) {
	return (
		<div className="flex justify-between flex-col w-[280px] h-[calc(100vh-80px)]">
			<div className="flex flex-col pt-11 w-[280px]">
				<button
					className="flex gap-2 pl-11 pt-5 pb-5"
					onClick={() => {
						setPage(1);
					}}
				>
				...
				>
					<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						/>
						<path
							d="M10.6666 16.4585H9.33333C8.53333 16.4585 7.875 15.8002 7.875 15.0002V5.15853C7.875 4.35853 8.53333 3.7002 9.33333 3.7002H10.6666C11.4666 3.7002 12.125 4.35853 12.125 5.15853V15.0002C12.125 15.8002 11.4666 16.4585 10.6666 16.4585ZM9.33333 4.9502C9.21667 4.9502 9.125 5.04186 9.125 5.15853V15.0002C9.125 15.1169 9.21667 15.2085 9.33333 15.2085H10.6666C10.7833 15.2085 10.875 15.1169 10.875 15.0002V5.15853C10.875 5.04186 10.7833 4.9502 10.6666 4.9502H9.33333Z"
							fill="#696C70"
						/>
						<path
							d="M16.6666 16.4582H15.3333C14.5333 16.4582 13.875 15.7998 13.875 14.9998V2.49984C13.875 1.69984 14.5333 1.0415 15.3333 1.0415H16.6666C17.4666 1.0415 18.125 1.69984 18.125 2.49984V14.9998C18.125 15.7998 17.4666 16.4582 16.6666 16.4582ZM15.3333 2.2915C15.2167 2.2915 15.125 2.38317 15.125 2.49984V14.9998C15.125 15.1165 15.2167 15.2082 15.3333 15.2082H16.6666C16.7833 15.2082 16.875 15.1165 16.875 14.9998V2.49984C16.875 2.38317 16.7833 2.2915 16.6666 2.2915H15.3333Z"
							fill="#696C70"
						/>
					</svg>
